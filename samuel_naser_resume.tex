...
sammnaser@gmail.com & \url{github.com/Monkeyanator} & (502) 415-0878\\
\hline\hline
\end{tabular*}
\end{center}
...
\item Created mutating admission webhook which injects trace context into Kubernetes objects, and which was adopted as an official sig-instrumentation project \url{github.com/kubernetes-sigs/mutating-trace-admission-controller}
