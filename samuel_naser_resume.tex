...
\emph{BS, Computer Science,} 3.91 GPA & \emph{September 2017 to June 2020}
\end{tabular*}
{\small

\noindent
Relevant coursework: Systems Programming in Rust, Data Structures and Management, Human Computer Interaction, Introduction to Computer Graphics, Machine Learning: Foundations and Algorithms, Operating Systems, Distributed Systems, Database Systems, Networking, Programming Languages, Design and Analysis of Algorithms, Computer Systems Security, Introduction to Computer Systems
}
